...
{% include substack-subscribe.html note="I've also started putting these on Substack, so you can subscribe there if you want to get updates without having to check here: <a href='https://ronakrm.substack.com'>ronakrm.substack.com</a>" %}
