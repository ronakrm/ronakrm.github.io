...
\begin{minipage}[t]{0.55\textwidth}
	\vspace{0pt}
	{\fontsize{32}{36}\selectfont\bf Ronak Mehta.}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.4\textwidth}
	...
	\href{https://scholar.google.com/citations?user=zFRqln4AAAAJ&hl=en}{\faIcon{graduation-cap} Google Scholar}\quad \href{https://www.linkedin.com/in/ronak-mehta-64627491/}{\faIcon{linkedin} LinkedIn} \\
	ronakrm@gmail.com
\end{minipage}
...
\noindent{{\bf Coordinal Research. \href{https://coordinal.org}{coordinal.org}} \hfill \textit{San Francisco, CA}} \newline
{\bf \ Founder} \hfill \textit{Present}
\begin{itemize}[label={$\bullet$}]
	\item Architected production AI safety research automation framework: multi-agent orchestration with hierarchical delegation, three-tier real-time validation (local checks, policy engines, AI-judge code review), and time-travel debugging via immutable workspace snapshots.
	\item Built evaluation infrastructure integrating SWE-bench and RE-Bench with configurable agent scaffolding; deployed on AWS with warm EC2 instance pools, AWS Batch and IaC infrastructure for rapid benchmark iteration.
	\item Developed Python tooling for agent orchestration, telemetry (OpenTelemetry/Logfire), and CI/CD across specialized Docker and job requirements (GPU software stacks, \LaTeX, Lean4 automated theorem proving)
	\item Managed full organizational lifecycle: incubator/accelerator programs (Catalyze Impact, 50/50), C Corp incorporation, legal, and cloud infrastructure operations.
\end{itemize} 

\noindent{{\bf Machine Learning and Theory Scholars Program} \hfill \textit{Berkeley, CA}} \newline
{\bf \ Research Scholar} \hfill \textit{June 2024 - December 2024}
\begin{itemize}[label={$\bullet$}]
	...
	\item Applied classical optimization schemes such as Lipschitz optimization and mirror descent to find jailbreaks and identify regions in the input sequence space that may exhibit outlier behaviors.
\end{itemize} 

\noindent{{\bf Orca DB, Inc.} \hfill \textit{Boston, MA}} \newline
...
\noindent	{{\bf\large Computer Sciences, PhD} \hfill \textit{2016 - 2022}}
...
\textbf{Selected Publications:} ICLR 2023 (top 25\%), CVPR 2022, ICCV 2019 (x3), UAI 2019, 2021 (see \href{https://scholar.google.com/citations?user=zFRqln4AAAAJ&hl=en}{Google Scholar})

\noindent	{{\bf\large Computer Sciences, MS} \hfill \textit{2014 - 2016}}

{University of Wisconsin-Madison} 

%	\vspace{-5pt}
%	\begin{itemize}[label={$\bullet$}]
	%		\item Machine Learning and Computer Vision Research
	%	\end{itemize}
...
%	\begin{itemize}[label={$\circ$}]
	...
	%\item Thesis: Identifying Feature, Parameter, and Sample Subsets in Machine Learning and Image Analysis
	%\item 
	%\textbf{Selected Coursework:} Statistical Machine Learning, Computational Statistics, Nonconvex Optimization
	%	\end{itemize}

\noindent {{\bf\large Computer Engineering, B.S.E.} \hfill \textit{2010 - 2014} }
...
\noindent \textbf{Research Areas:} Interpretability by Design, Guaranteed-Safe AI, Statistical Machine Learning, Optimal Transport, Differential Geometry,  Convex/Non-convex Optimization

\noindent \textbf{AI/ML Systems:} LLM Agent Orchestration, Evaluation Frameworks (Inspect AI), LLM APIs, Agent Frameworks (DSPy, Pydantic-AI, Agents SDK), Coding Agents (Claude Code, Codex)

\noindent \textbf{Infrastructure:} Docker, IaC (Pulumi), Cloud management and job orchestration, CI/CD for full-stack AWS research automation (EC2, S3, ECR, AWS Batch, AWS VPC, CloudFront/Route53, IAM/SSM, OpenTelemetry/CloudWatch)

\noindent \textbf{Languages \& Web:} Python (PyTorch, Transformers, sklearn, NumPy/SciPy, Pandas), TypeScript (React, Vite, Next.js, Tailwind), R (lme4, ggplot), C++, Julia
