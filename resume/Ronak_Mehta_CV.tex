...
\begin{minipage}[t]{0.55\textwidth}
	\vspace{0pt}
	{\fontsize{36}{42}\selectfont\bf Ronak Mehta.}
\end{minipage}%
\hfill
...
{\bf \ Co-Founder} \hfill \textit{Present}
\begin{itemize}[label={$\bullet$}]
	\item Accelerating the research of safe and aligned AI systems
	\item Developing tools that accelerate the rate human researchers can make progress on alignment.
	\item Building automated research systems that can assist in alignment work today.
\end{itemize} 
